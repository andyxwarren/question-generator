...
const MIGRATED_PARAMS = {
    M05_Y5_MEAS: {
        ...
        2: { operations: ["direct_conversion", "reverse_conversion"], math: { types: ["length", "mass", "capacity"], conversions: { length: ["km_to_m", "m_to_cm"], mass: ["kg_to_g"], capacity: ["l_to_ml"] }, valueType: ["whole_only"], ranges: { km: { min: 1, max: 50 }, m: { min: 1, max: 5000 } } }, presentation: { wordProblems: false } },
        ...
        4: { operations: ["direct_conversion", "reverse_conversion", "word_problem", "multi_step_conversion"], math: { types: ["length", "mass", "capacity"], conversions: { length: ["km_to_m", "m_to_cm", "cm_to_mm"], mass: ["kg_to_g"], capacity: ["l_to_ml"] }, valueType: ["whole", "decimal"], ranges: { km: { min: 1, max: 200 }, m: { min: 1, max: 20000 } }, decimalPlaces: 3 }, presentation: { wordProblems: true } }
    }
};
