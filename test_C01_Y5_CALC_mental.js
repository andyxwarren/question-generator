/**
 * Test Suite for C01_Y5_CALC_mental Generator
 * Validates Schema v2.0 compliance across all operations and levels (1-4)
 */

import generator from './src/generators/C01_Y5_CALC_mental.js';
...
function testAllLevels() {
    console.log('=== Testing C01_Y5_CALC_mental Generator ===\n');

    const moduleId = 'C01_Y5_CALC';
